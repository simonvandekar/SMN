...
* We've been exploring ecological methods to fit a mass-univariate model across the whole-brain together using dimension reduction.
* It would be interesting to evaluate its MSE, bias, and variance relative to mass-univariate analysis to see whether it is better.
...
* Rank the projects using the google form I sent in an email
